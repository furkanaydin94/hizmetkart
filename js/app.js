...
console.log('Filtreler:', { locationFilter, selectedServices, selectedTurler });
...
async function loadData() {
    try {
        // Önce sessionStorage'dan özel veri kontrolü
        const customData = sessionStorage.getItem('customExcelData');

        if (customData) {
            const parsed = JSON.parse(customData);
            console.log('Özel Excel verisi yükleniyor (sessionStorage)...');
